...
<?php
	...
	$sql = "update portfolio set imageName = '$a', name = '$filename', description = '$b', size = '$filesize', type = '$filetype', path = '$filepath'  where id = '$id'";
	query($sql);
    echo"<script>location.replace('dashboard.php?page=portfolio_content');</script>";
}
?>
<!--For Data Retrive -->
<?php
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Portfolio Update</li>
          </ol>
        </section>
            ...
            <div class="col-md-6 col-md-offset-3">
              ...
              <div class="box box-primary">
                <div class="box-header" style="text-align:center">
                  <h3 class="box-title">Portfolio Update</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" name="portfolio_image" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="title">Image Title</label>
                      <input type="text" class="form-control" id="imageName" name="imageName" value="<?php echo $title;?>">
                    </div>
                    <div class="form-group">
