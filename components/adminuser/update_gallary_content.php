...
<?php
	...
	$sql = "update gallary set imageName = '$a', name = '$filename', description = '$b', size = '$filesize', type = '$filetype', path = '$filepath'  where id = '$id'";
	query($sql);
    echo"<script>location.replace('dashboard.php?page=gallary_content');</script>";
}
?>
<!--For Data Retrive -->
<?php
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Gallary Update</li>
          </ol>
        </section>
            ...
            <div class="col-md-6 col-md-offset-3">
              ...
              <div class="box box-primary">
                <div class="box-header" style="text-align:center">
                  <h3 class="box-title">Gallary Update</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" name="gallary" enctype="multipart/form-data">
                  <div class="box-body">
